...
public:
	...
	void PrepareScene();
	void RenderScene();
    // render spotlight shadow map each frame
    void RenderShadowMap(const glm::vec3& lightPosition, const glm::vec3& lightDirection);
